...
<form class="form-horizontal" action="/dashboard/users/" method='POST' enctype='multipart/form-data'>
    ...
    <div class="box-body">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="inputName" name='name' value="{{ old('name') }}" placeholder="Full Name">
                @if ($errors->has('name'))
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="password" class="form-control" id="inputPassword2" name='password-confirm' placeholder="Confirm Password">
        ...
        <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <option value='2' {{ old('isAdmin') == '2' ? 'selected' : '' }} >Moderator</option>
                    <option value='3' {{ old('isAdmin') == '3' ? 'selected' : '' }} >Editor</option>
                    <option value='4' {{ old('isAdmin') == '4' ? 'selected' : '' }} >User</option>
                    </select>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <option value='1' {{ old('name') == '1' ? 'selected' : '' }} >Approve</option>
                <option value='0' {{ old('name') == '2' ? 'selected' : '' }} >Disable</option>
                </select>
